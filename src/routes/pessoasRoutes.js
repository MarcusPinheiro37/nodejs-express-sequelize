...
router.get('/pessoas/:estudanteId/matriculas', (req, res, next) => pessoaControler.getMatriculasAtivas(req, res, next));
router.get('/pessoas/:estudanteId/matriculas/todos', (req, res, next) => pessoaControler.getMatriculas(req, res, next));
